...
const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    body: 'يتحمّل المتجر المسؤولية الكاملة عن محتواه منتجاته وأوصافه وصوره وأسعاره. تُقدّم أدوات الذكاء الاصطناعي في النظام كمساعدة اختيارية ولا تُلزم أوريكس بدقة نتائجها في كل حالة. تتم العملية التجارية (الطلب، الدفع، التوصيل، الإرجاع) بين المتجر والعميل مباشرةً، وتكون أوريكس وسيطاً تقنياً لتشغيل النظام فقط وليس طرفاً في العقد التجاري.',
  },
  {
