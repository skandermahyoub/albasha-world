...
import { Code2, Palette, Database, Shield, Smartphone, Zap, Radio, FileImage, GitBranch } from 'lucide-react';
...
const TECH = [
  ...
  { icon: Database, name: 'قاعدة بيانات BaaS', desc: 'كيانات وبيانات قابلة للإدارة لدعم المتجر والتشغيل' },
