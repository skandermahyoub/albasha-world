  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <h1 className="font-heading font-bold text-2xl">مركز أداء المتجر</h1>
      </div>
      ...
      <div className="mt-6 bg-card border border-border/50 rounded-xl p-4 text-sm text-muted-foreground">
        المؤشرات هنا محسوبة مباشرة من الطلبات والمخزون والمصروفات، دون أي خدمة ذكاء اصطناعي أو تكامل خارجي.
      </div>
    </div>
  );
}